...
function toSummaryContract(request: NextRequest, analysis: LunarAnalysis) {
  return {
    ...
    demoMode: analysis.params.demo || analysis.meta.source === 'demo',
    ...
    return NextResponse.json(
      {
        ...
        hint: 'Set GITHUB_TOKEN or LUNAR_GITHUB_TOKEN, or add ?demo=1 for clearly marked synthetic demo data.',
